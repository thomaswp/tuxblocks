...
@implementation TBHashCode

@synthesize result = result_;
- (id<TBHashCode_Hashable>)hashable {
  return hashable_;
}
- (void)setHashable:(id<TBHashCode_Hashable>)hashable {
  JreOperatorRetainedAssign(&hashable_, self, hashable);
}
...
- (void)setLastObject:(id)lastObject {
  JreOperatorRetainedAssign(&lastObject_, self, lastObject);
}
...
- (TBHashCode *)compareTo {
  return compareTo_;
}
- (void)setCompareTo:(TBHashCode *)compareTo {
  JreOperatorRetainedAssign(&compareTo_, self, compareTo);
}
...
- (NSUInteger)hash {
  inHash_ = YES;
  result_ = 1;
  [((id<TBHashCode_Hashable>) NIL_CHK(hashable_)) addFieldsWithTBHashCode:self];
  inHash_ = NO;
  return result_;
}

- (void)addHashWithId:(id)o {
  result_ = TBHashCode_prime * result_ + ((o == nil) ? 0 : [NIL_CHK(o) hash]);
}

- (void)addHashWithInt:(int)i {
  result_ = TBHashCode_prime * result_ + i;
}

- (void)addHashWithLongInt:(long long int)l {
  result_ = TBHashCode_prime * result_ + (int) (l ^ ((long long) (((unsigned long long) l) >> 32)));
}

- (void)addHashWithShortInt:(short int)s {
  result_ = TBHashCode_prime * result_ + s;
}

- (void)addHashWithFloat:(float)f {
  result_ = TBHashCode_prime * result_ + [JavaLangFloat floatToIntBitsWithFloat:f];
}

- (void)addHashWithDouble:(double)d {
  long long int temp;
  temp = [JavaLangDouble doubleToLongBitsWithDouble:d];
  result_ = TBHashCode_prime * result_ + (int) (temp ^ ((long long) (((unsigned long long) temp) >> 32)));
}

- (void)addHashWithChar:(char)b {
  result_ = TBHashCode_prime * result_ + b;
}

- (void)addHashWithUnichar:(unichar)c {
  result_ = TBHashCode_prime * result_ + c;
}

- (void)addHashWithBOOL:(BOOL)b {
  result_ = TBHashCode_prime * result_ + (b ? 1231 : 1237);
}

- (void)addLeftEqualsWithId:(id)o {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  BOOL eq;
  id o2 = ((TBHashCode *) NIL_CHK(compareTo_)).lastObject;
  if (o == nil) {
    eq = o2 == nil;
  }
  else {
...
- (void)addLeftEqualsWithInt:(int)i {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (i != ((TBHashCode *) NIL_CHK(compareTo_)).lastInt) equalSoFar_ = NO;
  fieldIndex_++;
}
...
- (void)addLeftEqualsWithLongInt:(long long int)l {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (l != ((TBHashCode *) NIL_CHK(compareTo_)).lastLong) equalSoFar_ = NO;
  fieldIndex_++;
}
...
- (void)addLeftEqualsWithShortInt:(short int)s {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (s != ((TBHashCode *) NIL_CHK(compareTo_)).lastShort) equalSoFar_ = NO;
  fieldIndex_++;
}
...
- (void)addLeftEqualsWithFloat:(float)f {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (f != ((TBHashCode *) NIL_CHK(compareTo_)).lastFloat) equalSoFar_ = NO;
  fieldIndex_++;
}
...
- (void)addLeftEqualsWithDouble:(double)d {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (d != ((TBHashCode *) NIL_CHK(compareTo_)).lastDouble) equalSoFar_ = NO;
  fieldIndex_++;
}
...
- (void)addLeftEqualsWithChar:(char)b {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (b != ((TBHashCode *) NIL_CHK(compareTo_)).lastByte) equalSoFar_ = NO;
  fieldIndex_++;
}
...
- (void)addLeftEqualsWithUnichar:(unichar)c {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (c != ((TBHashCode *) NIL_CHK(compareTo_)).lastChar) equalSoFar_ = NO;
  fieldIndex_++;
}
...
- (void)addLeftEqualsWithBOOL:(BOOL)b {
  if (!equalSoFar_) return;
  [((TBHashCode *) NIL_CHK(compareTo_)) populateFieldWithInt:fieldIndex_];
  if (b != ((TBHashCode *) NIL_CHK(compareTo_)).lastBoolean) equalSoFar_ = NO;
  fieldIndex_++;
}

- (void)addRightEqualsWithId:(id)o {
  if (desiredFieldIndex_ >= 0 && fieldIndex_++ != desiredFieldIndex_) return;
  JreOperatorRetainedAssign(&lastObject_, self, o);
}
...
- (BOOL)equalsWithTBHashCode:(TBHashCode *)hash_ {
  ...
  id<TBHashCode_Hashable> hashable = ((TBHashCode *) NIL_CHK(hash_)).hashable;
  if (self.hashable == hashable) return YES;
  if (self.hashable == nil || hashable == nil) return NO;
  if ([(id<JavaObject>) ((id<TBHashCode_Hashable>) NIL_CHK(self.hashable)) getClass] != [(id<JavaObject>) ((id<TBHashCode_Hashable>) NIL_CHK(hashable)) getClass]) return NO;
  if ([((TBHashCode *) NIL_CHK(hash_)) hash] != [self hash]) return NO;
  equalSoFar_ = YES;
  inLeftEquals_ = YES;
  JreOperatorRetainedAssign(&compareTo_, self, hash_);
  desiredFieldIndex_ = -1;
  fieldIndex_ = 0;
  [((id<TBHashCode_Hashable>) NIL_CHK(self.hashable)) addFieldsWithTBHashCode:self];
  inLeftEquals_ = NO;
  return equalSoFar_;
}

- (void)dealloc {
  JreOperatorRetainedAssign(&compareTo_, self, nil);
  JreOperatorRetainedAssign(&lastObject_, self, nil);
  JreOperatorRetainedAssign(&hashable_, self, nil);
  [super dealloc];
}

- (void)copyAllPropertiesTo:(id)copy {
  [super copyAllPropertiesTo:copy];
  TBHashCode *typedCopy = (TBHashCode *) copy;
