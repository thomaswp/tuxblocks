...
public class Constant {
	...
	public final static String BUTTON_BACK = IMAGE_PATH + "back.png";
	public final static String BUTTON_FORWARD = IMAGE_PATH + "forward.png";
	public final static String BUTTON_UP = IMAGE_PATH + "up.png";
	...
	public final static String BUTTON_CANCEL_BOREDERED = IMAGE_PATH + "cancel_bordered.png";
	...
	public final static String BUTTON_SCRATCH = IMAGE_PATH + "scratch.png";
	public static final String BUTTON_MENU = IMAGE_PATH + "options.png";
	
	public static final String IMAGE_HEART = IMAGE_PATH + "heart.png";
	public static final String IMAGE_CONFIRM = IMAGE_PATH + "confirm.png";
	...
	public static final String IMAGE_LOGO = IMAGE_PATH + "logo.png";
	public static final String IMAGE_START = IMAGE_PATH + "start.png";
