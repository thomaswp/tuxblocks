...
@interface TBPlayNObject : NSObject {
 @public
  TBHashCode *hashCode__;
}

@property (nonatomic, retain) TBHashCode *hashCode_;
...
typedef TBPlayNObject TuxkidsTuxblocksCorePlayNObject;

@interface TBPlayNObject_$1 : NSObject < PlaynCoreUtilCallback > {
 @public
  id<PlaynCoreImageLayer> val$layer_;
}

@property (nonatomic, retain) id<PlaynCoreImageLayer> val$layer;
...
@interface TBPlayNObject_$2 : NSObject < PlaynCoreUtilCallback > {
 @public
  TBImageLayerTintable *val$layer_;
}

@property (nonatomic, retain) TBImageLayerTintable *val$layer;
